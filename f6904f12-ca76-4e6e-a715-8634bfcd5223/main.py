#Tfrom surmount.base_class import Strategy, TargetAllocation
from surmount.technical_indicators import BB, RSI
from surmount.data import InsiderTrading
from datetime import datetime, timedelta

class TradingStrategy(Strategy):  # Renamed from MeanReversionStrategy
    def __init__(self):
    ...
    def run(self, data):
        ...
        for ticker in self.tickers:
            ...
            if bb_data and rsi_data and insider_data and ohlcv_data:
                ...
                # Buy signal: price near lower band, RSI oversold, insider buying
        ...
        return target_allocationype code here